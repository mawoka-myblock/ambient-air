...
### Battery Level (0x2a19) (u8) R
Battery percentage 0-100

### Battery Power (408813df-5dd4-1f87-ec11-cdb001100000) (i16) R
Battery average power in milli watt
...
### Temperature (561be71a-359d-4964-b64f-7b1c949b092e) (f32) R
Temperature in °C

### Humidity (13881d03-54b9-4b8c-be9f-8a0eeec6893b) (f32) R
...
### Pressure (7c4b9d53-cbce-409e-bb3d-06d7f9f263d8) (f32) R
Air pressure in kPa

### Temperature (a3f6145d-d2eb-46a6-aa41-9644a44bb18e) (f32) R
Temperature in °C

## Co2 Service (a6689992-6e99-4903-85ce-5750b7c4d995)
Data by STCC4

### Co2 (cfb04cf1-8d5b-4223-9ae5-c9e32b2940ab) (i16) R
...
## Index (55697045-6e90-4940-b055-a03f9ae10122) (i16) R
The VOC index according to Sensirion. Reads 0 when the sensor isn't ready
or deactivated

## Count (93c32824-5d3b-4343-a5e9-5699d165bc47) (i16) R
...
### Data (127ec103-86ea-4e75-9e35-2e0c772d6f85) (String) R
Reads sampling data as following structure:
```JSON
[
    {
        "temp_p": "number", // in milli °C (25°C -> 25000)
        "pressure": "number", // in Pa (50kPa -> 50000Pa)
        "temp_t": "number", // in milli °C (25°C -> 25000)
        "humidity": "number", // in %
        "co2": "number", // in ppm
        "voc": "number" // VOC index, if sensor activated, otherwise 0
    }
]
```
